...
const designSettingSchema = new mongoose.Schema({
  ...
  contactPhone: String,
  contactEmail: String,
  receptionLabel1: String,
  receptionHours1: String,
  receptionLabel2: String,
  receptionHours2: String,
  receptionLabel3: String,
  receptionHours3: String,
  disableScheduleAll: { type: Boolean, default: false },
  disableScheduleGroups: { type: Boolean, default: false },
  palmaresCards: [{
    name: String,
    title: String,
    record: String,
